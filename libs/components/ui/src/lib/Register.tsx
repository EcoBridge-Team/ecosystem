...
export const Register = () => {
  ...
  const onSubmit = (data: IFormInputs) => {
    ...
    const username = (Math.random().toString(36) + '00000000000000000').slice(
      2,
      5 + 2
    );
    userService
      .registerNewUser({ password, email, username })
      .then(() => {
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <a
                href="#"
                className="font-medium text-white md:text-green-600 hover:text-green-700"
              >
