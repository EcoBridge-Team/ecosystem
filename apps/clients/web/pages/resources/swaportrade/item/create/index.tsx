...
export default function CreateItem(): JSX.Element {
  return (
    <Layout background="xl:bg-surface xl:bg-cover">
      <div className="justify-center flex h-full">
        <div className="inline-block align-center place-self-center text-center mx-5">
          <div className="flex justify-center items-center flex-col mb-10">
            <h2 className="text-2xl md:text-4xl md:text-left font-extrabold text-green-600 mb-5">
              Register a new resource
            </h2>
            <p className="text-green-600">
              Register a new resource in the community market and exchange it or
              give it away easily.
            </p>
          </div>
          <MarketResourcesForm />
